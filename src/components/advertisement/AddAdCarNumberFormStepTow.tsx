...
export default function AddAdCarNumberStepTow() {
  const [addAdvertisement, { isLoading }] = useAddAdvertisementMutation();
  const router = useRouter();
  const form = useForm<CarNumberFormValues>({
    resolver: zodResolver(CarNumberFormSchema),
    defaultValues: {
      name: "",
      price: "",
      conditionPrice: "",
  ...
  async function onSubmit(data: CarNumberFormValues) {
